...
class Fred():
    ...
    def __init__(self, api_key=None, api_key_dir=None):
        '''
        ...
        elif api_key_dir is not None:
            with open('/Users/terrill/OneDrive/Documents/work/projects/spy/scripts/economics/api_key.txt', 'r') as f:
